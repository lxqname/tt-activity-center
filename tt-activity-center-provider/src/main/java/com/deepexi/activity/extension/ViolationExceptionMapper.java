package com.deepexi.activity.extension;
...
public class ViolationExceptionMapper implements ExceptionMapper<ResteasyViolationException> {
    ...
    public Response toResponse(ResteasyViolationException e) {
        ...
        return Response.status(Response.Status.OK).entity(new Payload<>(null, CODE_400, message)).type(ContentType.APPLICATION_JSON_UTF_8).build();
    }
}